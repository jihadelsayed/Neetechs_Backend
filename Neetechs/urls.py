...
legacy_redirect_patterns = [
    ...
    path("api/v1/profile/profile/Interest/<int:id>", legacy_redirect_view("/api/v1/profile/interests/{id}/", status_code=308)),
    path("api/v1/profile/profile/list/Studys", legacy_redirect_view("/api/v1/profile/studies/", status_code=308)),
    path("api/v1/profile/profile/post/Studys", legacy_redirect_view("/api/v1/profile/studies/create/", status_code=308)),
