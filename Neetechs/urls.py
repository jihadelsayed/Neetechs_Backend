...
legacy_redirect_patterns = [
    ...
    path("api/v1/profile/profile/allprofileinfo/<str:site_id>", legacy_redirect_view("/api/v1/profile/all/{site_id}/", status_code=308)),
    path("api/v1/profile/profile/list/CompetenceCertificates", legacy_redirect_view("/api/v1/profile/competences/", status_code=308)),
    path("api/v1/profile/profile/post/CompetenceCertificates", legacy_redirect_view("/api/v1/profile/competences/create/", status_code=308)),
    path("api/v1/profile/profile/CompetenceCertificate/<int:id>/", legacy_redirect_view("/api/v1/profile/competences/{id}/", status_code=308)),
    path("api/v1/profile/profile/CompetenceCertificate/<int:id>", legacy_redirect_view("/api/v1/profile/competences/{id}/", status_code=308)),
    path("api/v1/profile/profile/list/Interests", legacy_redirect_view("/api/v1/profile/interests/", status_code=308)),
    path("api/v1/profile/profile/post/Interests", legacy_redirect_view("/api/v1/profile/interests/create/", status_code=308)),
    path("api/v1/profile/profile/Interest/<int:id>/", legacy_redirect_view("/api/v1/profile/interests/{id}/", status_code=308)),
    path("api/v1/profile/profile/Interest/<int:id>", legacy_redirect_view("/api/v1/profile/interests/{id}/", status_code=308)),
    path("api/v1/profile/profile/list/studies", legacy_redirect_view("/api/v1/profile/studies/", status_code=308)),
    path("api/v1/profile/profile/post/studies", legacy_redirect_view("/api/v1/profile/studies/create/", status_code=308)),
    path("api/v1/profile/profile/Study/<int:id>/", legacy_redirect_view("/api/v1/profile/studies/{id}/", status_code=308)),
    path("api/v1/profile/profile/Study/<int:id>", legacy_redirect_view("/api/v1/profile/studies/{id}/", status_code=308)),
    path("api/v1/profile/profile/list/Experiences", legacy_redirect_view("/api/v1/profile/experience/", status_code=308)),
    path("api/v1/profile/profile/post/Experiences", legacy_redirect_view("/api/v1/profile/experience/create/", status_code=308)),
    path("api/v1/profile/profile/Experience/<int:id>/", legacy_redirect_view("/api/v1/profile/experience/{id}/", status_code=308)),
    path("api/v1/profile/profile/Experience/<int:id>", legacy_redirect_view("/api/v1/profile/experience/{id}/", status_code=308)),
]
